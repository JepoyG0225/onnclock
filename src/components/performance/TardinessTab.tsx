            ...
            {isSuperAdmin && (
              <div className="xl:col-span-5">
                ...
                <select
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-accent/40"
                >
          ...
          <CardContent className="pt-5 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-primary">{stats.totalTardy}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-5 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-primary">{stats.totalAbsent}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-5 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-primary">{stats.employeesWithTardiness}</p>
              </div>
            </div>
          </CardContent>
        </Card>
