                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-20 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                      <div
                        className={`h-1.5 rounded-full ${done === total ? 'bg-emerald-500' : 'bg-primary'}`}
      ...
      <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={addTask}
                className="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-lg bg-primary text-white hover:bg-primary/90"
              >
        ...
        <div className="px-6 py-4 border-t border-slate-200 shrink-0 flex gap-3">
          ...
          <button
            onClick={save}
            disabled={saving}
            className="flex-1 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary/90 disabled:opacity-60 flex items-center justify-center gap-2"
          >
    ...
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary/90 transition-colors"
        >
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-slate-100 rounded-xl p-1 w-fit" data-tour="onb-status-tabs">
        {([['active', 'Active Onboardings'], ['templates', 'Templates']] as const).map(([key, label]) => (
          ...
          >
            ...
            {key === 'active' && active.length > 0 && (
              <span className="ml-1.5 px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-primary text-white">{active.length}</span>
            )}
          </button>
        ))}
      </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary/90 transition-colors"
            >
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
              ...
              <button
                onClick={() => setShowBuilder(true)}
                className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white bg-primary hover:bg-primary/90"
              >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {t.isDefault && (
                            <span className="px-2 py-0.5 rounded-full text-[11px] font-bold bg-primary text-white">Default</span>
                          )}
                        </div>
