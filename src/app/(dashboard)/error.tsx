...
/**
 * Dashboard-level error boundary. Catches any uncaught exception thrown
 * by server components in the (dashboard) tree (dashboard layout,
 * permission loader, page server data fetches) and renders a graceful
 * retry UI instead of Next.js's generic "application error" page. The
 * digest is surfaced so we can grep Vercel logs by reference.
 */
