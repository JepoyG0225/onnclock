  ...
  return (
    <div className="space-y-6 print:space-y-3">
      ...
      <div className="flex items-center justify-between print:hidden">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#000000' }}>Final Pay Calculator</h1>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <Button onClick={compute} disabled={!employeeId || computing} style={{ background: 'var(--brand-highlight)' }}>
      ...
      {data && !computing && (
        <div className="space-y-4 print:space-y-2">
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between flex-wrap gap-3">
                <div>
                  ...
                  <h2 className="text-xl font-bold mt-1" style={{ color: '#000000' }}>{data.employee.name}</h2>
              ...
              <table className="w-full text-sm">
                <tbody>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="p-3 text-right font-bold text-lg" style={{ color: '#000000' }}>{peso(data.result.grossPay)}</td>
                  </tr>
                </tbody>
              </table>
            </CardContent>
          ...
          {/* Net */}
          <Card className="print:break-inside-avoid" style={{ background: 'rgba(184, 225, 0,0.06)', borderColor: 'rgba(184, 225, 0,0.2)' }}>
            <CardContent className="p-5 flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wide">Net Final Pay</p>
                <p className="text-3xl font-bold" style={{ color: 'var(--brand-highlight)' }}>{peso(data.result.netFinalPay)}</p>
              </div>
