  ...
  return (
    <div className="min-h-screen bg-[#eef2f7] flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        {/* Header band */}
        <div className="bg-gradient-to-r from-[#0d1b2a] to-primary px-8 py-7 flex items-center gap-4">
        ...
        <div className="px-8 py-6 space-y-5">
          ...
          {hasInstaller ? (
            <a
              ...
              className="flex items-center justify-center gap-2.5 w-full bg-accent hover:bg-[#c44d00] text-white font-bold text-sm py-3.5 rounded-xl transition-colors shadow-md"
            >
              {/* Download icon */}
          ...
          <div className="space-y-2">
            ...
            <ol className="space-y-1.5 text-xs text-gray-600">
              <li className="flex gap-2"><span className="font-bold text-accent flex-shrink-0">1.</span> Download and run the installer above</li>
              <li className="flex gap-2"><span className="font-bold text-accent flex-shrink-0">2.</span> OnClock Desktop installs silently and opens automatically</li>
              <li className="flex gap-2"><span className="font-bold text-accent flex-shrink-0">3.</span> Sign in with your OnClock email &amp; password</li>
              <li className="flex gap-2"><span className="font-bold text-accent flex-shrink-0">4.</span> Clock in from the app — monitoring starts automatically</li>
            </ol>
          </div>
        ...
        <div className="border-t border-gray-100 px-8 py-4 flex items-center justify-between">
          ...
          <Link href="/portal/login" className="text-xs font-semibold text-accent hover:underline">
            Open Portal →
          </Link>
        </div>
      </div>
