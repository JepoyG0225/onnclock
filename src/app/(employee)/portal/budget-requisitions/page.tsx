          ...
          {filtered.map(req => (
            ...
            >
              ...
              >
                ...
                >
                  <FileText className="w-4 h-4" style={{ color: 'var(--brand-highlight)' }} />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base font-bold mt-1" style={{ color: '#000000' }}>
                ...
                <div className="border-t border-gray-100 px-3 sm:px-4 pb-3 sm:pb-4 pt-3 space-y-3">
                    ...
                    <table className="w-full text-xs">
                      ...
                      <tfoot>
                        <tr className="border-t border-gray-200 bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-right text-sm font-bold" style={{ color: '#000000' }}>{fmtPeso(req.totalAmount)}</td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
                  ...
                  <div className="sm:hidden space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-gray-200">
                      ...
                      <span className="text-sm font-bold" style={{ color: '#000000' }}>{fmtPeso(req.totalAmount)}</span>
                    </div>
                  </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {/* Headers (desktop only — on mobile each row is a stacked
                    card with its own labels via placeholders). */}
                <div className="hidden sm:grid grid-cols-[1fr_60px_64px_88px_28px] gap-1.5 mb-1 px-0.5">
                ...
                {items.map((it, i) => (
                  <div
                    key={i}
                    className="grid grid-cols-1 sm:grid-cols-[1fr_60px_64px_88px_28px] gap-2 sm:gap-1.5 mb-3 sm:mb-1.5 items-stretch sm:items-center p-3 sm:p-0 rounded-lg sm:rounded-none border border-gray-100 sm:border-0 bg-gray-50/60 sm:bg-transparent"
                  >
                    {/* Row title on mobile so each card is self-labelling */}
                    <div className="flex items-center justify-between sm:hidden">
                      ...
                      <button
                        ...
                        type="button"
                        className="text-[11px] font-semibold text-red-500 hover:text-red-700 disabled:opacity-30"
                      >
                        Remove
                      </button>
                    </div>
                    <input
                      className="border border-gray-200 rounded-lg px-2.5 py-2 text-sm sm:text-xs outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-100"
                    ...
                    <input
                      ...
                      inputMode="decimal"
                      className="border border-gray-200 rounded-lg px-2 py-2 text-sm sm:text-xs outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-100 sm:text-right"
                      placeholder="Qty"
                      value={it.quantity}
                      onChange={e => updateItem(i, 'quantity', e.target.value)}
                    />
                    <input
                      className="border border-gray-200 rounded-lg px-2 py-2 text-sm sm:text-xs outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-100"
                    ...
                    />
                    {/* Desktop delete X (mobile uses the inline Remove link above) */}
                    <button
                      onClick={() => removeItem(i)}
                      disabled={items.length === 1}
                      type="button"
                      className="hidden sm:flex w-7 h-7 rounded-lg border border-red-200 text-red-400 hover:bg-red-50 disabled:opacity-30 disabled:cursor-not-allowed items-center justify-center transition-colors"
                    >
                      <X className="w-3 h-3" />
                    </button>
                  </div>
                ...
                <div className="text-right text-sm font-bold mt-2 pt-2 border-t border-gray-100" style={{ color: '#000000' }}>
