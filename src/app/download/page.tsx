    ...
    <div className="min-h-screen bg-[#f5f8fb]">
      ...
      <main className="pt-28 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <section className="rounded-3xl bg-gradient-to-r from-primary to-[#000000] px-6 py-10 sm:px-10 text-white shadow-xl">
                  ...
                  {platforms.map((platform) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700 hover:border-[#000000] hover:bg-white transition-all"
                      >
                        <span className="inline-flex items-center gap-2">
                          <Image src={platform.icon} alt={platform.label} width={18} height={18} />
                          {platform.label}
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 text-xs text-slate-500">
            ...
            <Link href="/login" className="font-semibold text-[#000000] hover:underline">
              Back to Sign In
            </Link>
          </div>
        </div>
