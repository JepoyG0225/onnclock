  ...
  return (
    <div className="flex flex-col h-full px-3 pb-3 pt-2">
      ...
      <div className="text-center mb-2">
        <p className="text-[8px] text-[#c4d9ff]/70 font-semibold">Good morning,</p>
        <p className="text-[9px] text-white font-black">Maria R.</p>
      </div>

      {/* Live Clock */}
      <div className="text-center mb-1">
        <p className="text-[26px] font-black text-[#c4d9ff] tabular-nums leading-none tracking-tight">
          {hh}:{mm}
        </p>
      ...
      <div className="flex gap-0 mt-1 bg-white/5 rounded-xl overflow-hidden">
        <div className="flex-1 text-center py-2">
          <p className="text-[9px] font-black text-[#c4d9ff]">8:02</p>
          ...
          <div className="flex-1 space-y-4">
            {FEATURES.map((f, i) => (
              ...
              >
                ...
                >
                  <f.icon className="w-4 h-4 text-[#c4d9ff]" />
                </div>
                <div>
