    ...
    <html lang="en">
      <body style={{ margin: 0, fontFamily: 'system-ui, -apple-system, sans-serif', background: '#f0f6f8', minHeight: '100vh' }}>
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
          <div style={{ width: '100%', maxWidth: 440, borderRadius: 16, background: '#fff', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.10), 0 8px 10px -6px rgba(0,0,0,0.10)', border: '1px solid #d4d4d4', overflow: 'hidden' }}>
            <div style={{ padding: '32px 24px 24px', textAlign: 'center' }}>
              ...
              <h1 style={{ fontSize: 18, fontWeight: 900, color: '#000000', margin: 0 }}>Something went wrong</h1>
              <p style={{ fontSize: 14, color: '#343434', marginTop: 12, lineHeight: 1.5 }}>
                We couldn&apos;t load this page. This is usually a temporary
                issue — try refreshing in a moment.
              </p>
              {error.digest && (
                <p style={{ marginTop: 12, fontSize: 10, fontFamily: 'ui-monospace, SFMono-Regular, monospace', color: '#777777', wordBreak: 'break-all' }}>
                  Reference: {error.digest}
                </p>
              )}
            </div>
            <div style={{ padding: '16px 24px', background: '#f7f7f7', borderTop: '1px solid #d4d4d4', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <button
                onClick={() => reset()}
                style={{ padding: '10px 16px', borderRadius: 8, fontSize: 14, fontWeight: 600, color: '#fff', background: '#000000', border: 'none', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
              >
                Try again
              </button>
              <button
                ...
                style={{ padding: '10px 16px', borderRadius: 8, fontSize: 14, fontWeight: 600, color: '#343434', background: 'transparent', border: '1px solid #d4d4d4', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
              >
                Sign out
              </button>
            </div>
